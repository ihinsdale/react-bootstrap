...
var propTypes = {
  ...
  panelBodyStyle: _propTypes2['default'].object
};
...
var Panel = function (_React$Component) {
  ...
  Panel.prototype.renderBody = function renderBody(rawChildren, bsProps, panelBodyStyle) {
    var children = [];
    var bodyChildren = [];
    ...
    function maybeAddBody() {
      ...
      children.push(_react2['default'].createElement(
        'div',
        { key: children.length, className: bodyClassName, style: panelBodyStyle },
        bodyChildren
      ));
  ...
  Panel.prototype.render = function render() {
    var _props = this.props,
        ...
        panelBodyStyle = _props.panelBodyStyle,
        props = (0, _objectWithoutProperties3['default'])(_props, ['collapsible', 'header', 'id', 'footer', 'expanded', 'headerRole', 'panelRole', 'className', 'children', 'onEnter', 'onEntering', 'onEntered', 'onExit', 'onExiting', 'onExited', 'panelBodyStyle']);
    ...
    return _react2['default'].createElement(
      ...
      collapsible ? this.renderCollapsibleBody(id, expanded, panelRole, children, bsProps, { onEnter: onEnter, onEntering: onEntering, onEntered: onEntered, onExit: onExit, onExiting: onExiting, onExited: onExited }, panelBodyStyle) : this.renderBody(children, bsProps, panelBodyStyle),
